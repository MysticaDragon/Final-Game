...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x=800, y=100, speed = 2):
        super().__init__()
        self.right_images = [pygame.image.load('assets/images/small_enemy_1.png').convert(),
                             pygame.image.load('assets/images/small_enemy_2.png').convert()]
        ...
        self.animation_delay = 300  # Delay between animation frames in milliseconds
